...
<div class="container">
  ...
  <form action="Controle/CadastrarTarefa.php" method="POST">
    <div class="form-group">
      ...
      <input type="id" class="form-control" id="idTarefa" placeholder="insira o ID " name="id">
    </div>
    <div class="form-group">
      <label for="NomeTarefa">Tarefa:</label>
      <input type="name" class="form-control" id="NomeTarefa" placeholder="insira o nome da tarefa" name="tarefa">
    </div>
     <div class="form-group">
     ...
     <div class="form-group">
      ...
      <input type="name" class="form-control" id="nome_criador" placeholder="Digite seu nome" name="user_criador">
    </div>
